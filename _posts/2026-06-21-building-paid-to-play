...
I’ve been working on [this app](https://www.sanchezner.com/paid-to-play) for the past two months. In this post, I’ll be talking about how I built it and why the most important decision was admitting the chart couldn’t answer the question I originally wanted it to.
